...
declare namespace ts.TestFSWithWatch {
    ...
    export function checkWatchedFiles(host: TestServerHost, expectedFiles: readonly string[], additionalInfo?: string): void;
    ...
    export function checkWatchedDirectories(host: TestServerHost, expectedDirectories: string[], recursive: boolean): void;
    ...
    export class TestServerHost implements server.ServerHost, FormatDiagnosticsHost, ModuleResolutionHost {
        ...
        constructor(withSafeList: boolean, fileOrFolderorSymLinkList: readonly FileOrFolderOrSymLink[], { useCaseSensitiveFileNames, executingFilePath, currentDirectory, newLine, windowsStyleRoot, environmentVariables, runWithoutRecursiveWatches, runWithFallbackPolling }?: TestServerHostCreationParameters);
        writeOutputIsTTY(): boolean;
        getNewLine(): string;
        ...
        ensureFileOrFolder(fileOrDirectoryOrSymLink: FileOrFolderOrSymLink, ignoreWatchInvokedWithTriggerAsFileCreate?: boolean, ignoreParentWatch?: boolean): void;
        ...
        invokeFsWatchesCallbacks(fullPath: string, eventName: "rename" | "change", entryFullPath?: string): void;
        invokeFsWatchesRecursiveCallbacks(fullPath: string, eventName: "rename" | "change", entryFullPath?: string): void;
        ...
        diff(baseline: string[], base?: ESMap<string, FSEntry>): void;
        serializeWatches(baseline: string[]): void;
...
declare namespace FourSlash {
    ...
    export class TestState {
        ...
        verifyOrganizeImports(newContent: string): void;
        private raiseError;
        ...
        verifyReferenceGroups(starts: ArrayOrSingle<string> | ArrayOrSingle<Range>, parts: readonly FourSlashInterface.ReferenceGroup[]): void;
        ...
        verifyGetReferencesForServerTest(expected: readonly ts.ReferenceEntry[]): void;
        verifySingleReferenceGroup(definition: FourSlashInterface.ReferenceGroupDefinition, ranges?: Range[] | string): void;
        ...
        verifyImportFixModuleSpecifiers(markerName: string, moduleSpecifiers: string[]): void;
        ...
        verifyRefactorAvailable(negative: boolean, triggerReason: ts.RefactorTriggerReason, name: string, actionName?: string): void;
...
declare namespace FourSlashInterface {
    ...
    export class Verify extends VerifyNegatable {
        ...
        getReferencesForServerTest(expected: readonly ts.ReferenceEntry[]): void;
        singleReferenceGroup(definition: ReferenceGroupDefinition, ranges?: FourSlash.Range[] | string): void;
    ...
    export function classification(format: ts.SemanticClassificationFormat): {
        ...
        comment: (text: string, position?: number | undefined) => Classification;
        identifier: (text: string, position?: number | undefined) => Classification;
        keyword: (text: string, position?: number | undefined) => Classification;
        numericLiteral: (text: string, position?: number | undefined) => Classification;
        operator: (text: string, position?: number | undefined) => Classification;
        stringLiteral: (text: string, position?: number | undefined) => Classification;
        whiteSpace: (text: string, position?: number | undefined) => Classification;
        text: (text: string, position?: number | undefined) => Classification;
        punctuation: (text: string, position?: number | undefined) => Classification;
        docCommentTagName: (text: string, position?: number | undefined) => Classification;
        className: (text: string, position?: number | undefined) => Classification;
        enumName: (text: string, position?: number | undefined) => Classification;
        interfaceName: (text: string, position?: number | undefined) => Classification;
        moduleName: (text: string, position?: number | undefined) => Classification;
        typeParameterName: (text: string, position?: number | undefined) => Classification;
        parameterName: (text: string, position?: number | undefined) => Classification;
        typeAliasName: (text: string, position?: number | undefined) => Classification;
        jsxOpenTagName: (text: string, position?: number | undefined) => Classification;
        jsxCloseTagName: (text: string, position?: number | undefined) => Classification;
        jsxSelfClosingTagName: (text: string, position?: number | undefined) => Classification;
        jsxAttribute: (text: string, position?: number | undefined) => Classification;
        jsxText: (text: string, position?: number | undefined) => Classification;
        jsxAttributeStringLiteralValue: (text: string, position?: number | undefined) => Classification;
        getClassification: (classificationType: ts.ClassificationTypeNames, text: string, position?: number | undefined) => Classification;
    ...
    export namespace Completion {
        ...
        const globalTypes: readonly ExpectedCompletionEntry[];
        function globalTypesPlus(plus: readonly ExpectedCompletionEntry[]): readonly ExpectedCompletionEntry[];
        ...
        const undefinedVarEntry: ExpectedCompletionEntry;
        const globalsInsideFunction: (plus: readonly ExpectedCompletionEntry[]) => readonly ExpectedCompletionEntry[];
        const globalsInJsInsideFunction: (plus: readonly ExpectedCompletionEntry[]) => readonly ExpectedCompletionEntry[];
        ...
        function globalsPlus(plus: readonly ExpectedCompletionEntry[]): readonly ExpectedCompletionEntry[];
        function globalsInJsPlus(plus: readonly ExpectedCompletionEntry[]): readonly ExpectedCompletionEntry[];
    }
...
declare namespace Harness {
    ...
    class TypeWriterWalker {
        ...
        private checker;
        constructor(program: ts.Program, fullTypeCheck: boolean, hadErrorBaseline: boolean);
